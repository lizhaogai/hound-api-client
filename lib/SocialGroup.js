...
class SocialGroup {
  ...
  /**
   * Find a related item by id for mediaEffects.
   *
   * @method
   * @path [GET] /SocialGroups/{id}/mediaEffects/{fk}
   * @name SocialGroup#findMediaEffectsById
   * @param {string} id - SocialGroup id
   * @param {string} fk - Foreign key for mediaEffects
   * @param {function} [cb] - Callback function
   */
  findMediaEffectsById(id, fk, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling findMediaEffectsById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling findMediaEffectsById");
    }
    ...
    const path = utils.buildPath('/SocialGroups/{id}/mediaEffects/{fk}', {
      id: id,
      fk: fk,
    });
  ...
  /**
   * Delete a related item by id for mediaEffects.
   *
   * @method
   * @path [DELETE] /SocialGroups/{id}/mediaEffects/{fk}
   * @name SocialGroup#destroyMediaEffectsById
   * @param {string} id - SocialGroup id
   * @param {string} fk - Foreign key for mediaEffects
   * @param {function} [cb] - Callback function
   */
  destroyMediaEffectsById(id, fk, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling destroyMediaEffectsById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling destroyMediaEffectsById");
    }
  ...
  /**
   * Update a related item by id for mediaEffects.
   *
   * @method
   * @path [PUT] /SocialGroups/{id}/mediaEffects/{fk}
   * @name SocialGroup#updateMediaEffectsById
   * @param {string} id - SocialGroup id
   * @param {string} fk - Foreign key for mediaEffects
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
   * @param {function} [cb] - Callback function
   */
  updateMediaEffectsById(id, fk, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling updateMediaEffectsById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling updateMediaEffectsById");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
  ...
  /**
   * Queries mediaEffects of SocialGroup.
   *
   * @method
   * @path [GET] /SocialGroups/{id}/mediaEffects
   * @name SocialGroup#getMediaEffects
   * @param {string} id - SocialGroup id
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.filter] - filter
   * @param {function} [cb] - Callback function
   */
  getMediaEffects(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling getMediaEffects");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
    ...
    const path = utils.buildPath('/SocialGroups/{id}/mediaEffects', {
      id: id,
    });
  ...
  /**
   * Creates a new instance in mediaEffects of this model.
   *
   * @method
   * @path [POST] /SocialGroups/{id}/mediaEffects
   * @name SocialGroup#createMediaEffects
   * @param {string} id - SocialGroup id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
   * @param {function} [cb] - Callback function
   */
  createMediaEffects(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling createMediaEffects");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
  ...
  /**
   * Deletes all mediaEffects of this model.
   *
   * @method
   * @path [DELETE] /SocialGroups/{id}/mediaEffects
   * @name SocialGroup#deleteMediaEffects
   * @param {string} id - SocialGroup id
   * @param {function} [cb] - Callback function
   */
  deleteMediaEffects(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling deleteMediaEffects");
    }
  ...
  /**
   * Counts mediaEffects of SocialGroup.
   *
   * @method
   * @path [GET] /SocialGroups/{id}/mediaEffects/count
   * @name SocialGroup#countMediaEffects
   * @param {string} id - SocialGroup id
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.where] - Criteria to match model instances
   * @param {function} [cb] - Callback function
   */
  countMediaEffects(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling countMediaEffects");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
    ...
    const path = utils.buildPath('/SocialGroups/{id}/mediaEffects/count', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /SocialGroups/{id}/latestMembers
   * @name SocialGroup#latestMembers
   * @param {string} id - SocialGroup id
   * @param {string} beginDate - 开始时间
   * @param {string} endDate - 结束时间
   * @param {function} [cb] - Callback function
   */
  latestMembers(id, beginDate, endDate, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling latestMembers");
    }
    // verify the required parameter 'beginDate' is set
    if (beginDate === undefined || beginDate === null) {
      throw new Error("Missing the required parameter 'beginDate' when calling latestMembers");
    }
    // verify the required parameter 'endDate' is set
    if (endDate === undefined || endDate === null) {
      throw new Error("Missing the required parameter 'endDate' when calling latestMembers");
    }
    ...
    const path = utils.buildPath('/SocialGroups/{id}/latestMembers', {
      id: id,
    });
