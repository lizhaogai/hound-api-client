...
class SocialGroup {
  ...
  /**
   * Find a related item by id for mediaEffect.
   *
   * @method
   * @path [GET] /SocialGroups/{id}/mediaEffect/{fk}
   * @name SocialGroup#findMediaEffectById
   * @param {string} id - SocialGroup id
   * @param {string} fk - Foreign key for mediaEffect
   * @param {function} [cb] - Callback function
   */
  findMediaEffectById(id, fk, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling findMediaEffectById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling findMediaEffectById");
    }
    ...
    const path = utils.buildPath('/SocialGroups/{id}/mediaEffect/{fk}', {
      id: id,
      fk: fk,
    });
  ...
  /**
   * Delete a related item by id for mediaEffect.
   *
   * @method
   * @path [DELETE] /SocialGroups/{id}/mediaEffect/{fk}
   * @name SocialGroup#destroyMediaEffectById
   * @param {string} id - SocialGroup id
   * @param {string} fk - Foreign key for mediaEffect
   * @param {function} [cb] - Callback function
   */
  destroyMediaEffectById(id, fk, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling destroyMediaEffectById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling destroyMediaEffectById");
    }
  ...
  /**
   * Update a related item by id for mediaEffect.
   *
   * @method
   * @path [PUT] /SocialGroups/{id}/mediaEffect/{fk}
   * @name SocialGroup#updateMediaEffectById
   * @param {string} id - SocialGroup id
   * @param {string} fk - Foreign key for mediaEffect
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
   * @param {function} [cb] - Callback function
   */
  updateMediaEffectById(id, fk, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling updateMediaEffectById");
    }
    // verify the required parameter 'fk' is set
    if (fk === undefined || fk === null) {
      throw new Error("Missing the required parameter 'fk' when calling updateMediaEffectById");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
  ...
  /**
   * Queries mediaEffect of SocialGroup.
   *
   * @method
   * @path [GET] /SocialGroups/{id}/mediaEffect
   * @name SocialGroup#getMediaEffect
   * @param {string} id - SocialGroup id
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.filter] - filter
   * @param {function} [cb] - Callback function
   */
  getMediaEffect(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling getMediaEffect");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
    ...
    const path = utils.buildPath('/SocialGroups/{id}/mediaEffect', {
      id: id,
    });
  ...
  /**
   * Creates a new instance in mediaEffect of this model.
   *
   * @method
   * @path [POST] /SocialGroups/{id}/mediaEffect
   * @name SocialGroup#createMediaEffect
   * @param {string} id - SocialGroup id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
   * @param {function} [cb] - Callback function
   */
  createMediaEffect(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling createMediaEffect");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
  ...
  /**
   * Deletes all mediaEffect of this model.
   *
   * @method
   * @path [DELETE] /SocialGroups/{id}/mediaEffect
   * @name SocialGroup#deleteMediaEffect
   * @param {string} id - SocialGroup id
   * @param {function} [cb] - Callback function
   */
  deleteMediaEffect(id, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling deleteMediaEffect");
    }
  ...
  /**
   * Counts mediaEffect of SocialGroup.
   *
   * @method
   * @path [GET] /SocialGroups/{id}/mediaEffect/count
   * @name SocialGroup#countMediaEffect
   * @param {string} id - SocialGroup id
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.where] - Criteria to match model instances
   * @param {function} [cb] - Callback function
   */
  countMediaEffect(id, opts, cb) {
    // verify the required parameter 'id' is set
    if (id === undefined || id === null) {
      throw new Error("Missing the required parameter 'id' when calling countMediaEffect");
    }
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
    ...
    const path = utils.buildPath('/SocialGroups/{id}/mediaEffect/count', {
      id: id,
    });
