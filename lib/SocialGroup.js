...
class SocialGroup {
   ...
   *
   * @method
   * @path [GET] /SocialGroups/{id}/owner
   * @name SocialGroup#getOwner
  ...
  getOwner(id, opts, cb) {
    ...
    const path = utils.buildPath('/SocialGroups/{id}/owner', {
      id: id,
    });
  ...
  bind(mid, wid, cb) {
    ...
    if (mid === undefined || mid === null) {
      throw new Error("Missing the required parameter 'mid' when calling bind");
    }
    // verify the required parameter 'wid' is set
    if (wid === undefined || wid === null) {
      throw new Error("Missing the required parameter 'wid' when calling bind");
    }
