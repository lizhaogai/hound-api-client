...
class Company {
   ...
   *
   * @method
   * @path [GET] /Companies/{id}/socialGroups/{fk}
   * @name Company#findSocialGroupsById
   * @param {string} id - Company id
  ...
  findSocialGroupsById(id, fk, cb) {
    ...
    const path = utils.buildPath('/Companies/{id}/socialGroups/{fk}', {
      id: id,
      fk: fk,
    });
   ...
   *
   * @method
   * @path [DELETE] /Companies/{id}/socialGroups/{fk}
   * @name Company#destroySocialGroupsById
   * @param {string} id - Company id
   * @param {string} fk - Foreign key for socialGroups
   * @param {function} [cb] - Callback function
   */
   ...
   *
   * @method
   * @path [PUT] /Companies/{id}/socialGroups/{fk}
   * @name Company#updateSocialGroupsById
   * @param {string} id - Company id
   * @param {string} fk - Foreign key for socialGroups
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
  ...
  /**
   * Queries socialGroups of Company.
   *
   * @method
   * @path [GET] /Companies/{id}/socialGroups
   * @name Company#getSocialGroups
   * @param {string} id - Company id
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.filter] - filter
   * @param {function} [cb] - Callback function
  ...
  getSocialGroups(id, opts, cb) {
    ...
    const path = utils.buildPath('/Companies/{id}/socialGroups', {
      id: id,
    });
   ...
   *
   * @method
   * @path [POST] /Companies/{id}/socialGroups
   * @name Company#createSocialGroups
   * @param {string} id - Company id
   * @param {object|function|*} [opts] - Optional params
   * @param {object} [opts.data] - data
   * @param {function} [cb] - Callback function
   ...
   *
   * @method
   * @path [DELETE] /Companies/{id}/socialGroups
   * @name Company#deleteSocialGroups
   * @param {string} id - Company id
   * @param {function} [cb] - Callback function
   */
  ...
  /**
   * Counts socialGroups of Company.
   *
   * @method
   * @path [GET] /Companies/{id}/socialGroups/count
  ...
  countSocialGroups(id, opts, cb) {
    ...
    const path = utils.buildPath('/Companies/{id}/socialGroups/count', {
      id: id,
    });
   ...
   *
   * @method
   * @path [GET] /Companies/socialGroupMembers/count
   * @name Company#countSocialGroupsMembers
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.id] - 公司ID
   * @param {string} [opts.type] - 只查询该公司(true),查全部就传false
   * @param {function} [cb] - Callback function
   */
  countSocialGroupsMembers(opts, cb) {
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
    }
    ...
    const path = '/Companies/socialGroupMembers/count';
   ...
   *
   * @method
   * @path [GET] /Companies/subCompanies
   * @name Company#getSubCompanies
   * @param {object|function|*} [opts] - Optional params
   * @param {string} [opts.id] - 公司ID
   * @param {function} [cb] - Callback function
   */
  getSubCompanies(opts, cb) {
    if (typeof opts === 'function') {
      cb = opts;
      opts = null;
    }
    ...
    const path = '/Companies/subCompanies';
